...
export const weeklyReviews = pgTable("weekly_reviews", {
  ...
  studyTagBreakdown: jsonb("study_tag_breakdown").$type<Partial<Record<StudyTag, number>>>().default({}),
  moodBreakdown: jsonb("mood_breakdown").$type<Partial<Record<MoodType, number>>>().default({}),
